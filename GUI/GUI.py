...
class App:
    def __init__(self, root):
        ...
        self.settings.start_initial_setup(root, self.on_settings_complete)
    ...
    def on_settings_complete(self):
        # Get settings from InitialSettings
        self.language = self.settings.language
        self.participant_name = self.settings.participant_name
        self.parent_directory = self.settings.parent_directory
        self.process_mode = self.settings.process_mode
        ...
        # Start with initial configuration check
        self.initial_config_check()
    ...
    def prompt_number_of_trials(self):
        """Get number of trials from settings and create folder structure"""
        self.num_trials = self.settings.num_trials
    ...
    def generate_config_toml(self):
        """Generate initial Config.toml file"""
        config_file_path = os.path.join(self.parent_directory, self.participant_name, 'Config.toml')
        
        # Use config_template from settings.py
